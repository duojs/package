...
function Package(repo, ref) {
  ...
  this.tok = auth && auth.password || null;
...
Package.prototype.provider = function (provider) {
  if (0 == arguments.length) return this._provider;
  this._provider = provider;
  // TODO: meh
  this._provider.resolve = thunk(this._provider.resolve);
  return this;
};
...
Package.prototype.resolve = unyield(function *() {
  ...
  var ref = yield provider.resolve(this.repo, this.ref);
...
Package.prototype.fetch = unyield(function *() {
  ...
  var url = provider.tarball(this.repo, ref);
